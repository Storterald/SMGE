...
import nodeLogic.Object
import math.Vec3

class Object3D(initialId: String = "", initialPosition: Vec3 = Vec3(0.0f, 0.0f, 0.0f), initialAnchorPoint: Vec3 = Vec3(0.0f, 0.0f, 0.0f)) : Object(initialId) {
    init {
