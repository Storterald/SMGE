...
class TextLabelTest {
    ...
    @Test
    fun firstConstructor_createsAllCharLabelChildren() {
        val textLabel = TextLabel(text = "Test")
    ...
    @Test
    fun secondConstructor_createsAllCharLabelChildren() {
        val textLabel = TextLabel(fontSize = 35.0f, text = "Test")
        assertEquals(4, textLabel.getChildrenCount())
    }

    @Test
    fun secondConstructor_throwsIfFontSizeIs0() {
        assertThrows<IllegalArgumentException> { TextLabel(fontSize = 0.0f, text = "Test") }
    }

    @Test
    fun secondConstructor_throwsIfFontSizeIsNegative() {
    ...
    @Test
    fun thirdConstructor_createsAllCharLabelChildren() {
        val textLabel = TextLabel(text = "Test", fontFile = File("src\\test\\resources\\testFont.otf"))
        assertEquals(4, textLabel.getChildrenCount())
    }
    ...
    @Test
    fun fourthConstructor_createsAllCharLabelChildren() {
        val textLabel = TextLabel(fontSize = 35.0f, text = "Test", fontFile = File("src\\test\\resources\\testFont.otf"))
        assertEquals(4, textLabel.getChildrenCount())
    }
    ...
    @Test
    fun fifthConstructor_createsAllCharLabelChildren() {
        val textLabel = TextLabel(text = "Test", fontPath = "src\\test\\resources\\testFont.otf")
        assertEquals(4, textLabel.getChildrenCount())
    }
    ...
    @Test
    fun sixthConstructor_createsAllCharLabelChildren() {
        val textLabel = TextLabel(fontSize = 35.0f, text = "Test", fontPath = "src\\test\\resources\\testFont.otf")
        assertEquals(4, textLabel.getChildrenCount())
    }
    ...
    @Test
    fun firstSetFont_changesTheFont() {
        val textLabel = TextLabel(text = "Test")
    ...
    @Test
    fun firstSetFont_changesTheSize() {
        val textLabel = TextLabel(text = "Test")
        textLabel.setFont(Font.createFont(Font.TRUETYPE_FONT, File("src\\test\\resources\\testFont.otf")))
    ...
    @Test
    fun secondSetFont_changesTheFont() {
        val textLabel = TextLabel(text = "Test")
    ...
    @Test
    fun secondSetFont_changesTheSize() {
        val textLabel = TextLabel(text = "Test")
        textLabel.setFont(File("src\\test\\resources\\testFont.otf"))
    ...
    @Test
    fun thirdSetFont_changesTheSize() {
        val textLabel = TextLabel(text = "Test")
        textLabel.setFont("src\\test\\resources\\testFont.otf")
    ...
    @Test
    fun setFontSize_changesTheFontSize() {
        val textLabel = TextLabel(text = "Test")
