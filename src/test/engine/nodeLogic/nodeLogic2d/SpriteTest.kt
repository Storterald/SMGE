...
class SpriteTest {
    ...
    @Test fun firstConstructor_createsSpriteWithoutThrowing() {
    ...
    @Test fun firstSetImage_doesNotThrowIfValidAndChangesSize() {
        val sprite = Sprite(filePath = "src\\test\\resources\\dirt512x.png")
    ...
    @Test fun secondSetImage_throwsIfFileDoesNotExist() {
        val sprite = Sprite(filePath = "src\\test\\resources\\dirt512x.png")
        assertThrows<IllegalStateException> { sprite.setImage("thisFileDoesNotExist.png") }
    }

    @Test fun secondSetImage_throwsIfFileExtensionIsInvalid() {
        val sprite = Sprite(filePath = "src\\test\\resources\\dirt512x.png")
