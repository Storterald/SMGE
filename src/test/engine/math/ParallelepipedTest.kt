...
class ParallelepipedTest {
    ...
    @Test fun defaultConstructor_createsParallelepipedWithoutThrowing() {
    ...
    @Test fun defaultConstructor_throwsIfZ2IsLowerThanZ1() {
        assertThrows<IllegalArgumentException> { Parallelepiped(1.0f, 3.0f, 2.0f, 4.0f, 4.0f, -7.0f) }
    }

    @Test fun secondConstructor_createsParallelepipedWithoutThrowing() {
    ...
    @Test fun secondConstructor_throwsIfDepthIsNegative() {
        assertThrows<IllegalArgumentException> { Parallelepiped(134.0f, 12.0f, -5.0f) }
    }

    @Test fun thirdConstructor_createsParallelepipedWithoutThrowing() {
    ...
    @Test fun thirdConstructor_createsParallelepipedWithCorrectValues() {
    ...
    @Test fun thirdConstructor_throwsIfDepthIsNegative() {
        assertThrows<IllegalArgumentException> { Parallelepiped(Vector3f(20.0f, 10.0f, 10.0f), 100.0f, 30.0f, -10.0f) }
    }

    @Test fun fourthConstructor_createsParallelepipedWithoutThrowing() {
    ...
    @Test fun fourthConstructor_createsParallelepipedWithCorrectValues() {
    ...
    @Test fun fourthConstructor_throwsIfZSizeIsNegative() {
        assertThrows<IllegalArgumentException> { Parallelepiped(Vector3f(20.0f, 10.0f, 10.0f), Vector3f(100.0f, 30.0f, -1.0f)) }
    }
