...
class Object2DTest {
    ...
    fun constructor_throwsIfXSizeIsNegative() {
        assertThrows<IllegalArgumentException> { Object2D(size = Vec2(-1.0f, 0.0f)) }
    }

    @Test
    fun constructor_throwsIfYSizeIsNegative() {
        assertThrows<IllegalArgumentException> { Object2D(size = Vec2(0.0f, -1.0f)) }
    }

    @Test
    fun constructor_throwsIfSizeIsNegative() {
        assertThrows<IllegalArgumentException> { Object2D(size = Vec2(-1.0f, -1.0f)) }
    }
    ...
    fun size_doesNotThrowIfValid() {
        ...
        assertDoesNotThrow { object2D.size = Vec2(1.0f, 1.0f) }
    }
    ...
    fun scaledSize_calculatesScaledSize() {
        val object2D = Object2D(size = Vec2(100.0f, 100.0f), scale = Vec2(0.5f, 0.5f))
    ...
    fun anchoredPosition_calculatesAnchoredPosition() {
        val object2D = Object2D(size = Vec2(100.0f, 100.0f), position = Vec2(100.0f, 100.0f), anchorPoint = Vec2(0.5f, 0.25f))
    ...
    fun absolutePosition_calculatesAbsolutePosition() {
        val object2D = Object2D(size = Vec2(100.0f, 100.0f), position = Vec2(100.0f, 100.0f), anchorPoint = Vec2(0.25f, 0.50f), scale = Vec2(0.5f, 0.5f))
